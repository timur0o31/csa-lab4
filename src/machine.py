...
from src.isa import from_bytes_to_data, from_bytes_to_instructions, instr_to_bytes, Opcode
...
if __name__ == "__main__":
    ...
    assert len(sys.argv) == 4, "Wrong arguments: machine.py <instructions_file> <data_file> <input_file>"
